...
class Usuario(db.Model):
    ...
    # ¡IMPORTANTE! Eliminamos la línea de relación.
    # La colección 'clientes' se crea automáticamente
    # mediante el backref='clientes' definido en el modelo Cliente.
    # (Línea eliminada: clientes = db.relationship("Cliente", backref="usuario_cliente", lazy=True))
